...
!function (t, e) {
    ...
    var n, o, r, a = "object", s = function (t) {
        ...
        })), u = {}.propertyIsEnumerable, d = Object.getOwnPropertyDescriptor, f = {
            f: d && !u.call({1: 2}, 1) ? function (t) {
                var e = d(this, t);
                return !!e && e.enumerable
            } : u
        }, p = function (t, e) {
            return {enumerable: !(1 & t), configurable: !(2 & t), writable: !(4 & t), value: e}
        }, g = {}.toString, v = function (t) {
            return g.call(t).slice(8, -1)
        }, b = "".split, y = c((function () {
        ...
        }, k = {}.hasOwnProperty, O = function (t, e) {
            return k.call(t, e)
        }, T = l.document, C = S(T) && S(T.createElement), P = function (t) {
        ...
        })), I = Object.getOwnPropertyDescriptor, A = {
            f: h ? I : function (t, e) {
        ...
        })), V = _("native-function-to-string", Function.toString), B = l.WeakMap,
        L = "function" == typeof B && /native code/.test(V.call(B)), D = 0, H = Math.random(), M = function (t) {
            return "Symbol(" + String(void 0 === t ? "" : t) + ")_" + (++D + H).toString(36)
        }, U = _("keys"), q = function (t) {
            return U[t] || (U[t] = M(t))
        }, z = {}, W = l.WeakMap;
    if (L) {
        var G = new W, K = G.get, J = G.has, Y = G.set;
        n = function (t, e) {
    ...
    var Q = {
            set: n, get: o, has: r, enforce: function (t) {
                return r(t) ? o(t) : n(t, {})
            ...
            var e = Q.get, i = Q.enforce, n = String(V).split("toString");
        ...
        }, nt = Math.ceil, ot = Math.floor, rt = function (t) {
            return isNaN(t = +t) ? 0 : (t > 0 ? ot : nt)(t)
        }, at = Math.min, st = function (t) {
            return t > 0 ? at(rt(t), 9007199254740991) : 0
        }, lt = Math.max, ct = Math.min, ht = function (t, e) {
            var i = rt(t);
            return i < 0 ? lt(i + e, 0) : ct(i, e)
        }, ut = function (t) {
            return function (e, i, n) {
                var o, r = w(e), a = st(r.length), s = ht(n, a);
                if (t && i != i) {
                    for (; a > s;) if ((o = r[s++]) != o) return !0
                } else for (; a > s; s++) if ((t || s in r) && r[s] === i) return t || s || 0;
                return !t && -1
            }
        }, dt = {includes: ut(!0), indexOf: ut(!1)}, ft = dt.indexOf, pt = function (t, e) {
            var i, n = w(t), o = 0, r = [];
        ...
        vt = gt.concat("length", "prototype"), bt = {
            f: Object.getOwnPropertyNames || function (t) {
                return pt(t, vt)
            }
        }, yt = {f: Object.getOwnPropertySymbols}, mt = it("Reflect", "ownKeys") || function (t) {
            var e = bt.f(E(t)), i = yt.f;
        ...
        }, St = /#|\.prototype\./, xt = function (t, e) {
            var i = Ot[kt(t)];
            return i == Ct || i != Tt && ("function" == typeof e ? c(e) : !!e)
        }, kt = xt.normalize = function (t) {
            return String(t).replace(St, ".").toLowerCase()
        }, Ot = xt.data = {}, Tt = xt.NATIVE = "N", Ct = xt.POLYFILL = "P", Pt = xt, $t = A.f, It = function (t, e) {
            var i, n, o, r, a, s = t.target, c = t.global, h = t.stat;
            if (i = c ? l : h ? l[s] || F(s, {}) : (l[s] || {}).prototype) for (n in e) {
            ...
            return t
        }, Ft = it("document", "documentElement"), _t = q("IE_PROTO"), Vt = function () {
        }, Bt = function () {
            var t, e = P("iframe"), i = gt.length;
    ...
    var Dt = bt.f, Ht = {}.toString,
        ...
        Ut = {
        ...
        }, qt = l.Symbol, zt = _("wks"), Wt = function (t) {
            return zt[t] || (zt[t] = At && qt[t] || (At ? qt : M)("Symbol." + t))
        }, Gt = {f: Wt}, Kt = N.f, Jt = function (t) {
            var e = tt.Symbol || (tt.Symbol = {});
            O(e, t) || Kt(e, t, {value: Gt.f(t)})
        }, Yt = N.f, Xt = Wt("toStringTag"), Qt = function (t, e, i) {
            t && !O(t = i ? t : t.prototype, Xt) && Yt(t, Xt, {configurable: !0, value: e})
        }, Zt = function (t) {
            ...
            return function (s, l, c, h) {
                for (var u, d, f = Rt(s), p = y(f), g = te(l, c, 3), v = st(p.length), b = 0, m = h || ie, w = e ? m(s, v) : i ? m(s, 0) : void 0; v > b; b++) if ((a || b in p) && (d = g(u = p[b], b, f), t)) if (e) w[b] = d; else if (d) switch (t) {
                    case 3:
                        return !0;
                    case 5:
                        return u;
        ...
        }, re = {forEach: oe(0), map: oe(1), filter: oe(2), some: oe(3), every: oe(4), find: oe(5), findIndex: oe(6)},
        ae = re.forEach, se = q("hidden"), le = Wt("toPrimitive"), ce = Q.set, he = Q.getterFor("Symbol"),
        ue = Object.prototype, de = l.Symbol, fe = l.JSON, pe = fe && fe.stringify, ge = A.f, ve = N.f, be = Ut.f,
        ye = f.f, me = _("symbols"), we = _("op-symbols"), Se = _("string-to-symbol-registry"),
        xe = _("symbol-to-string-registry"), ke = _("wks"), Oe = l.QObject,
        Te = !Oe || !Oe.prototype || !Oe.prototype.findChild, Ce = h && c((function () {
            return 7 != Lt(ve({}, "a", {
                get: function () {
            ...
            return ce(i, {type: "Symbol", tag: t, description: e}), h || (i.description = e), i
            ...
            t === ue && Ie(we, e, i), E(t);
            var n = x(e, !0);
            return E(i), O(me, n) ? (i.enumerable ? (O(t, se) && t[se][n] && (t[se][n] = !1), i = Lt(i, {enumerable: p(0, !1)})) : (O(t, se) || ve(t, se, p(1, {})), t[se][n] = !0), Ce(t, n, i)) : ve(t, n, i)
        }, Ae = function (t, e) {
            E(t);
            var i = w(e), n = Nt(i).concat(je(i));
            return ae(n, (function (e) {
                h && !Ee.call(i, e) || Ie(t, e, i[e])
            })), t
        }, Ee = function (t) {
            var e = x(t, !0), i = ye.call(this, e);
    ...
    At || (Z((de = function () {
        ...
        var t = arguments.length && void 0 !== arguments[0] ? String(arguments[0]) : void 0, e = M(t),
            i = function (t) {
    ...
    }), Z(ue, "propertyIsEnumerable", Ee, {unsafe: !0})), Gt.f = function (t) {
        return Pe(Wt(t), t)
    }), It({global: !0, wrap: !0, forced: !At, sham: !At}, {Symbol: de}), ae(Nt(ke), (function (t) {
        Jt(t)
    })), It({target: "Symbol", stat: !0, forced: !At}, {
        for: function (t) {
            var e = String(t);
    ...
    }), It({target: "Object", stat: !0, forced: !At, sham: !h}, {
        create: function (t, e) {
            return void 0 === e ? Lt(t) : Ae(Lt(t), e)
        }, defineProperty: Ie, defineProperties: Ae, getOwnPropertyDescriptor: Re
    }), It({target: "Object", stat: !0, forced: !At}, {
        ...
        target: "JSON", stat: !0, forced: !At || c((function () {
            var t = de();
    ...
    if (h && "function" == typeof _e && (!("description" in _e.prototype) || void 0 !== _e().description)) {
        ...
        Le.constructor = Be;
        var De = Le.toString, He = "Symbol(test)" == String(_e("test")), Me = /^Symbol\((.*)\)[^)]+$/;
        Fe(Le, "description", {
            configurable: !0, get: function () {
                var t = S(this) ? this.valueOf() : this, e = De.call(t);
                if (O(Ve, t)) return "";
    ...
    }, We = Wt("isConcatSpreadable"), Ge = !c((function () {
        var t = [];
        return t[We] = !1, t.concat()[0] !== t
    })), Ke = ze("concat"), Je = function (t) {
        if (!S(t)) return !1;
        var e = t[We];
        return void 0 !== e ? !!e : Et(t)
    };
    It({target: "Array", proto: !0, forced: !Ge || !Ke}, {
        concat: function (t) {
            var e, i, n, o, r, a = Rt(this), s = ie(a, 0), l = 0;
            for (e = -1, n = arguments.length; e < n; e++) if (r = -1 === e ? a : arguments[e], Je(r)) {
    ...
    var Ye = re.filter;
    It({target: "Array", proto: !0, forced: !ze("filter")}, {
        filter: function (t) {
            return Ye(this, t, arguments.length > 1 ? arguments[1] : void 0)
        }
    });
    var Xe = Wt("unscopables"), Qe = Array.prototype;
    ...
    }, ai = dt.indexOf, si = [].indexOf, li = !!si && 1 / [1].indexOf(1, -0) < 0, ci = ri("indexOf");
    It({target: "Array", proto: !0, forced: li || ci}, {
        indexOf: function (t) {
    ...
    })), pi = q("IE_PROTO"), gi = Object.prototype, vi = fi ? Object.getPrototypeOf : function (t) {
    ...
    var mi = {IteratorPrototype: hi, BUGGY_SAFARI_ITERATORS: yi}, wi = mi.IteratorPrototype,
        ...
        }() : void 0), xi = mi.IteratorPrototype, ki = mi.BUGGY_SAFARI_ITERATORS, Oi = Wt("iterator"),
        Ti = function () {
            return this
            ...
            var s, l, c, h = function (t) {
                ...
                }, u = e + " Iterator", d = !1, f = t.prototype, g = f[Oi] || f["@@iterator"] || o && f[o],
                v = !ki && g || h(o), b = "Array" == e && f.entries || g;
            if (b && (s = vi(b.call(new t)), xi !== Object.prototype && s.next && (vi(s) !== xi && (Si ? Si(s, xi) : "function" != typeof s[Oi] && j(s, Oi, Ti)), Qt(s, u, !0))), "values" == o && g && "values" !== g.name && (d = !0, v = function () {
                return g.call(this)
            }), f[Oi] !== v && j(f, Oi, v), o) if (l = {
                values: h("values"),
                keys: r ? v : h("keys"),
                entries: h("entries")
            }, a) for (c in l) !ki && !d && c in f || Z(f, c, l[c]); else It({target: e, proto: !0, forced: ki || d}, l);
            return l
        }, Pi = Q.set, $i = Q.getterFor("Array Iterator"), Ii = Ci(Array, "Array", (function (t, e) {
            Pi(this, {type: "Array Iterator", target: w(t), index: 0, kind: e})
        }), (function () {
            var t = $i(this), e = t.target, i = t.kind, n = t.index++;
    ...
    var Ai = [].join, Ei = y != Object, Ri = ri("join", ",");
    It({target: "Array", proto: !0, forced: Ei || Ri}, {
        join: function (t) {
            return Ai.call(w(this), void 0 === t ? "," : t)
        }
    });
    var Ni = Wt("species"), ji = [].slice, Fi = Math.max;
    It({target: "Array", proto: !0, forced: !ze("slice")}, {
        slice: function (t, e) {
            var i, n, o, r = w(this), a = st(r.length), s = ht(t, a), l = ht(void 0 === e ? a : e, a);
    ...
    var _i = [].sort, Vi = [1, 2, 3], Bi = c((function () {
        Vi.sort(void 0)
    })), Li = c((function () {
        Vi.sort(null)
    })), Di = ri("sort");
    It({target: "Array", proto: !0, forced: Bi || !Li || Di}, {
        sort: function (t) {
            return void 0 === t ? _i.call(Rt(this)) : _i.call(Rt(this), Zt(t))
        }
    });
    var Hi = Math.max, Mi = Math.min;
    It({target: "Array", proto: !0, forced: !ze("splice")}, {
        splice: function (t, e) {
            var i, n, o, r, a, s, l = Rt(this), c = st(l.length), h = ht(t, c), u = arguments.length;
    ...
    var Ui = function (t, e, i) {
        ...
        }, qi = "\t\n\v\f\r                　\u2028\u2029\ufeff", zi = "[" + qi + "]", Wi = RegExp("^" + zi + zi + "*"),
        Gi = RegExp(zi + zi + "*$"), Ki = function (t) {
            return function (e) {
                var i = String(m(e));
                return 1 & t && (i = i.replace(Wi, "")), 2 & t && (i = i.replace(Gi, "")), i
            }
        }, Ji = {start: Ki(1), end: Ki(2), trim: Ki(3)}, Yi = bt.f, Xi = A.f, Qi = N.f, Zi = Ji.trim, tn = l.Number,
        en = tn.prototype, nn = "Number" == v(Lt(en)), on = function (t) {
            var e, i, n, o, r, a, s, l, c = x(t, !1);
            if ("string" == typeof c && c.length > 2) if (43 === (e = (c = Zi(c)).charCodeAt(0)) || 45 === e) {
    ...
    var cn = Object.assign, hn = !cn || c((function () {
        var t = {}, e = {}, i = Symbol();
        return t[i] = 7, "abcdefghijklmnopqrst".split("").forEach((function (t) {
            e[t] = t
        })), 7 != cn({}, t)[i] || "abcdefghijklmnopqrst" != Nt(cn({}, e)).join("")
    })) ? function (t, e) {
        for (var i = Rt(t), n = arguments.length, o = 1, r = yt.f, a = f.f; n > o;) for (var s, l = y(arguments[o++]), c = r ? Nt(l).concat(r(l)) : Nt(l), u = c.length, d = 0; u > d;) s = c[d++], h && !a.call(l, s) || (i[s] = l[s]);
        return i
    } : cn;
    It({target: "Object", stat: !0, forced: Object.assign !== hn}, {assign: hn});
    var un = f.f, dn = function (t) {
        return function (e) {
            for (var i, n = w(e), o = Nt(n), r = o.length, a = 0, s = []; r > a;) i = o[a++], h && !un.call(n, i) || s.push(t ? [i, n[i]] : n[i]);
            return s
        }
    }, fn = {entries: dn(!0), values: dn(!1)}.entries;
    It({target: "Object", stat: !0}, {
        entries: function (t) {
            return fn(t)
        }
    });
    var pn = Wt("toStringTag"), gn = "Arguments" == v(function () {
        return arguments
    }()), vn = {};
    vn[Wt("toStringTag")] = "z";
    ...
    } : vn.toString, yn = Object.prototype;
    bn !== yn.toString && Z(yn, "toString", bn, {unsafe: !0});
    var mn = Ji.trim, wn = l.parseFloat, Sn = 1 / wn(qi + "-0") != -1 / 0 ? function (t) {
        var e = mn(String(t)), i = wn(e);
        return 0 === i && "-" == e.charAt(0) ? -0 : i
    } : wn;
    It({global: !0, forced: parseFloat != Sn}, {parseFloat: Sn});
    var xn = Ji.trim, kn = l.parseInt, On = /^[+-]?0[Xx]/,
    ...
    }, Pn = RegExp.prototype, $n = Pn.toString, In = c((function () {
    ...
    var Fn = function (t) {
        return function (e, i) {
            var n, o, r = String(m(e)), a = rt(i), s = r.length;
    ...
    }, _n = {codeAt: Fn(!1), charAt: Fn(!0)}, Vn = _n.charAt, Bn = Q.set, Ln = Q.getterFor("String Iterator");
    Ci(String, "String", (function (t) {
        Bn(this, {type: "String Iterator", string: String(t), index: 0})
    }), (function () {
        var t, e = Ln(this), i = e.string, n = e.index;
        return n >= i.length ? {value: void 0, done: !0} : (t = Vn(i, n), e.index += t.length, {value: t, done: !1})
    }));
    var Dn, Hn, Mn = RegExp.prototype.exec, Un = String.prototype.replace, qn = Mn,
    ...
    var Gn = qn, Kn = Wt("species"), Jn = !c((function () {
        var t = /./;
        ...
        if (!r || !a || "replace" === t && !Jn || "split" === t && !Yn) {
            var s = /./[o], l = i(o, ""[t], (function (t, e, i, n, o) {
                return e.exec === Gn ? r && !o ? {done: !0, value: s.call(e, i, n)} : {
                    done: !0,
                    value: t.call(i, e, n)
                } : {done: !1}
            })), h = l[0], u = l[1];
    ...
    }, Qn = _n.charAt, Zn = function (t, e, i) {
        ...
        return Gn.call(t, e)
    }, eo = Math.max, io = Math.min, no = Math.floor, oo = /\$([$&'`]|\d\d?|<[^>]*>)/g, ro = /\$([$&'`]|\d\d?)/g;
    Xn("replace", 2, (function (t, e, i) {
        return [function (i, n) {
            var o = m(this), r = null == i ? void 0 : i[t];
            return void 0 !== r ? r.call(i, o, n) : e.call(String(o), i, n)
        }, function (t, o) {
            var r = i(e, t, this, o);
            if (r.done) return r.value;
            var a = E(t), s = String(this), l = "function" == typeof o;
            l || (o = String(o));
            var c = a.global;
            if (c) {
                var h = a.unicode;
        ...
        function n(t, i, n, o, r, a) {
            var s = n + t.length, l = o.length, c = ro;
    ...
    Xn("split", 2, (function (t, e, i) {
        ...
        return n = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length ? function (t, i) {
            var n = String(m(this)), o = void 0 === i ? 4294967295 : i >>> 0;
            if (0 === o) return [];
            if (void 0 === t) return [n];
            if (!Rn(t)) return e.call(n, t, o);
            for (var r, a, s, l = [], c = (t.ignoreCase ? "i" : "") + (t.multiline ? "m" : "") + (t.unicode ? "u" : "") + (t.sticky ? "y" : ""), h = 0, u = new RegExp(t.source, c + "g"); (r = Gn.call(u, n)) && !((a = u.lastIndex) > h && (l.push(n.slice(h, r.index)), r.length > 1 && r.index < n.length && lo.apply(l, r.slice(1)), s = r[0].length, h = a, l.length >= o));) u.lastIndex === r.index && u.lastIndex++;
            ...
            var o = m(this), r = null == e ? void 0 : e[t];
            return void 0 !== r ? r.call(e, o, i) : n.call(String(o), e, i)
        }, function (t, o) {
            var r = i(n, t, this, o, n !== e);
            if (r.done) return r.value;
            var a = E(t), s = String(this), l = function (t, e) {
                ...
                u = new l(ho ? a : "^(?:" + a.source + ")", h), d = void 0 === o ? 4294967295 : o >>> 0;
            if (0 === d) return [];
            if (0 === s.length) return null === to(u, s) ? [s] : [];
            for (var f = 0, p = 0, g = []; p < s.length;) {
                u.lastIndex = ho ? p : 0;
                var v, b = to(u, ho ? s : s.slice(p));
                if (null === b || (v = co(st(u.lastIndex + (ho ? 0 : p)), s.length)) === f) p = Zn(s, p, c); else {
    ...
    var fo = {
        ...
        TextTrackList: 0,
        TouchList: 0
    }, po = re.forEach, go = ri("forEach") ? function (t) {
        return po(this, t, arguments.length > 1 ? arguments[1] : void 0)
    } : [].forEach;
    for (var vo in fo) {
        var bo = l[vo], yo = bo && bo.prototype;
    ...
    var mo = Wt("iterator"), wo = Wt("toStringTag"), So = Ii.values;
    for (var xo in fo) {
        var ko = l[xo], Oo = ko && ko.prototype;
        if (Oo) {
            if (Oo[mo] !== So) try {
                j(Oo, mo, So)
            } catch (t) {
            ...
            if (Oo[wo] || j(Oo, wo, xo), fo[xo]) for (var To in Ii) if (Oo[To] !== Ii[To]) try {
                j(Oo, To, Ii[To])
            } catch (t) {
                Oo[To] = Ii[To]
            }
    ...
    var Bo = {
        ...
        for (var l, c = o, h = 0, u = !!a && te(a, s, 3); h < n;) {
            if (h in i) {
                if (l = u ? u(i[h], h, e) : i[h], r > 0 && Et(l)) c = Lo(t, e, l, st(l.length), c, r - 1) - 1; else {
    ...
    It({target: "Array", proto: !0}, {
        flat: function () {
            var t = arguments.length ? arguments[0] : void 0, e = Rt(this), i = st(e.length), n = ie(e, 0);
    ...
    It({target: "Object", stat: !0, forced: Ho}, {
        keys: function (t) {
            return Nt(Rt(t))
        }
    });
    var Mo = {
        sprintf: function (t) {
            ...
            for (var h = 0; h < t.length; h++) {
                ...
                try {
                    for (var p, g = t[h][Symbol.iterator](); !(u = (p = g.next()).done); u = !0) {
                        var v = p.value, b = v.rowspan || 1, y = v.colspan || 1, m = i[h].indexOf(!1);
            ...
            var e = t.flat(), i = !0, n = !1, o = void 0;
            try {
                for (var r, a = t[Symbol.iterator](); !(i = (r = a.next()).done); i = !0) {
                    var s = r.value, l = !0, c = !1, h = void 0;
                    try {
            ...
            for (var e = 0, i = Object.entries(t); e < i.length; e++) {
                var n = Ao(i[e], 2), o = n[0], r = n[1], a = o.split(/(?=[A-Z])/).join("-").toLowerCase();
        ...
        return Io(e, [{
            ...
            key: "initHeader", value: function () {
                ...
                this.header = {
                    ...
                    n.push("<tr>"), 0 === o && !e.options.cardView && e.options.detailView && e.options.detailViewIcon && n.push('<th class="detail" rowspan="'.concat(e.options.columns.length, '">\n          <div class="fht-cell"></div>\n          </th>\n        ')), t.forEach((function (t, r) {
                        var a = Mo.sprintf(' class="%s"', t.class), s = t.widthUnit, l = parseFloat(t.width),
                        ...
                        if (u += Mo.sprintf("width: %s; ", !t.checkbox && !t.radio || l ? l ? l + s : void 0 : t.showSelectTitle ? void 0 : "36px"), void 0 !== t.fieldIndex || t.visible) {
                            ...
                            var d = e.options.escape ? Mo.escapeHTML(t.title) : t.title, f = d;
                ...
                t(window).off(o), !this.options.showHeader || this.options.cardView ? (this.$header.hide(), this.$tableHeader.hide(), this.$tableLoading.css("top", 0)) : (this.$header.show(), this.$tableHeader.show(), this.$tableLoading.css("top", this.$header.outerHeight() + 1), this.getCaret(), t(window).on(o, (function (t) {
                    ...
                    var n = i.currentTarget, o = t(n).prop("checked");
            ...
            key: "initSort", value: function () {
                ...
                -1 !== n && (this.options.sortStable && this.data.forEach((function (t, e) {
                    ...
                    var a = Mo.getItemField(o, e, t.options.escape), s = Mo.getItemField(r, e, t.options.escape),
            ...
            key: "initToolbar", value: function () {
                ...
                if (n.search || this.showSearchClearButton) {
                    ...
                    var g = this.$toolbar.find(".search input"), v = function () {
                ...
                if (this.filterOptions = this.filterOptions || this.options.filterOptions, "server" !== this.options.sidePagination) {
                    ...
                    this.data = e ? this.data.filter((function (i, o) {
                        for (var r = 0; r < t.header.fields.length; r++) if (t.header.searchables[r] && (!t.options.visibleSearch || -1 !== n.indexOf(t.header.fields[r]))) {
                            ...
                            if (s && s.searchFormatter && (l = Mo.calculateObjectValue(s, t.header.formatters[r], [l, i, o, s.field], l)), "string" == typeof l || "number" == typeof l) if (t.options.strictSearch) {
            ...
            key: "initPagination", value: function () {
                ...
                if (e.pagination) {
                    ...
                    if ("server" !== e.sidePagination && (e.totalRows = u.length), this.totalPages = 0, e.totalRows) {
                        if (e.pageSize === e.formatAllRows()) e.pageSize = e.totalRows, h = !0; else if (e.pageSize === e.totalRows) {
                    ...
                    if (c.push('<div class="'.concat(this.constants.classes.pull, "-").concat(e.paginationDetailHAlign, ' pagination-detail">\n      <span class="pagination-info">\n      ').concat(f, "\n      </span>")), !e.onlyInfoPagination) {
                        ...
                        var x = Math.round(e.paginationPagesBySide / 2), k = function (i) {
            ...
            key: "initRow", value: function (t, e, i, n) {
                ...
                if (!(Mo.findIndex(this.hiddenRows, t) > -1)) {
                    if ((a = Mo.calculateObjectValue(this.options, this.options.rowStyle, [t, e], a)) && a.css) for (var u = 0, d = Object.entries(a.css); u < d.length; u++) {
                        var f = Ao(d[u], 2), p = f[0], g = f[1];
                        s.push("".concat(p, ": ").concat(g))
                    }
                    if (c = Mo.calculateObjectValue(this.options, this.options.rowAttributes, [t, e], c)) for (var v = 0, b = Object.entries(c); v < b.length; v++) {
                        var y = Ao(b[v], 2);
                        p = y[0], g = y[1];
                        h.push("".concat(p, '="').concat(Mo.escapeHTML(g), '"'))
                    }
                    if (t._data && !Mo.isEmptyObject(t._data)) for (var m = 0, w = Object.entries(t._data); m < w.length; m++) {
                        var S = Ao(w[m], 2), x = S[0], k = S[1];
                        if ("index" === x) return;
                    ...
                    return r.push("<tr", Mo.sprintf(" %s", h.length ? h.join(" ") : void 0), Mo.sprintf(' id="%s"', Array.isArray(t) ? void 0 : t._id), Mo.sprintf(' class="%s"', a.classes || (Array.isArray(t) ? void 0 : t._class)), ' data-index="'.concat(e, '"'), Mo.sprintf(' data-uniqueid="%s"', Mo.getItemField(t, this.options.uniqueId, !1)), Mo.sprintf(' data-has-detail-view="%s"', !this.options.cardView && this.options.detailView && Mo.calculateObjectValue(null, this.options.detailFilter, [e, t]) ? "true" : void 0), Mo.sprintf("%s", l), ">"), this.options.cardView && r.push('<td colspan="'.concat(this.header.fields.length, '"><div class="card-views">')), !this.options.cardView && this.options.detailView && this.options.detailViewIcon && (r.push("<td>"), Mo.calculateObjectValue(null, this.options.detailFilter, [e, t]) && r.push('\n          <a class="detail-icon" href="#">\n          '.concat(Mo.sprintf(this.constants.html.icon, this.options.iconsPrefix, this.options.icons.detailOpen), "\n          </a>\n        ")), r.push("</td>")), this.header.fields.forEach((function (i, n) {
                        var a = "", l = Mo.getItemField(t, i, o.options.escape), c = "", h = "", u = {}, d = "",
                            f = o.header.classes[n], p = "", g = "", v = "", b = "", y = "", m = o.columns[n];
                        if ((!o.fromHtml || void 0 !== l || m.checkbox || m.radio) && m.visible && (!o.options.cardView || m.cardVisible)) {
                            if (m.escape && (l = Mo.escapeHTML(l)), s.concat([o.header.styles[n]]).length && (p = ' style="'.concat(s.concat([o.header.styles[n]]).join("; "), '"')), t["_".concat(i, "_id")] && (d = Mo.sprintf(' id="%s"', t["_".concat(i, "_id")])), t["_".concat(i, "_class")] && (f = Mo.sprintf(' class="%s"', t["_".concat(i, "_class")])), t["_".concat(i, "_rowspan")] && (v = Mo.sprintf(' rowspan="%s"', t["_".concat(i, "_rowspan")])), t["_".concat(i, "_colspan")] && (b = Mo.sprintf(' colspan="%s"', t["_".concat(i, "_colspan")])), t["_".concat(i, "_title")] && (y = Mo.sprintf(' title="%s"', t["_".concat(i, "_title")])), (u = Mo.calculateObjectValue(o.header, o.header.cellStyles[n], [l, t, e, i], u)).classes && (f = ' class="'.concat(u.classes, '"')), u.css) {
                                for (var w = [], S = 0, x = Object.entries(u.css); S < x.length; S++) {
                                    var k = Ao(x[S], 2), O = k[0], T = k[1];
                                    w.push("".concat(O, ": ").concat(T))
                                }
                                p = ' style="'.concat(w.concat(o.header.styles[n]).join("; "), '"')
                            }
                            if (c = Mo.calculateObjectValue(m, o.header.formatters[n], [l, t, e, i], l), t["_".concat(i, "_data")] && !Mo.isEmptyObject(t["_".concat(i, "_data")])) for (var C = 0, P = Object.entries(t["_".concat(i, "_data")]); C < P.length; C++) {
                                var $ = Ao(P[C], 2), I = $[0], A = $[1];
                                if ("index" === I) return;
                                g += " data-".concat(I, '="').concat(A, '"')
                            }
                            if (m.checkbox || m.radio) {
                                h = m.checkbox ? "checkbox" : h, h = m.radio ? "radio" : h;
                                var E = m.class || "", R = (!0 === c || l || c && c.checked) && !1 !== c,
            ...
            key: "initBodyEvent", value: function () {
                ...
                this.$body.find("> tr[data-index] > td").off("click dblclick").on("click dblclick", (function (i) {
                    var n = t(i.currentTarget), o = n.parent(), r = t(i.target).parents(".card-views").children(),
                        ...
                        u = e.columns[e.fieldsColumnsIndex[h]], d = Mo.getItemField(l, h, e.options.escape);
                ...
                if (this.options.showFooter && !this.options.cardView) {
                    ...
                    try {
                        for (var r, a = this.columns[Symbol.iterator](); !(i = (r = a.next()).done); i = !0) {
                            var s, l, c = r.value, h = [], u = {}, d = Mo.sprintf(' class="%s"', c.class);
                            if (c.visible) {
                                if (this.options.cardView && !c.cardVisible) return;
                                if (s = Mo.sprintf("text-align: %s; ", c.falign ? c.falign : c.align), l = Mo.sprintf("vertical-align: %s; ", c.valign), (u = Mo.calculateObjectValue(null, this.options.footerStyle, [c])) && u.css) for (var f = 0, p = Object.entries(u.css); f < p.length; f++) {
                                    var g = Ao(p[f], 2), v = g[0], b = g[1];
            ...
            key: "resetView", value: function (t) {
                ...
                if (t && t.height && (this.options.height = t.height), this.$selectAll.prop("checked", this.$selectItem.length > 0 && this.$selectItem.length === this.$selectItem.filter(":checked").length), this.$tableContainer.toggleClass("has-card-view", this.options.cardView), !this.options.cardView && this.options.showHeader && this.options.height ? (this.$tableHeader.show(), this.resetHeader(), e += this.$header.outerHeight(!0) + 1) : (this.$tableHeader.hide(), this.trigger("post-header")), !this.options.cardView && this.options.showFooter && (this.$tableFooter.show(), this.fitFooter(), this.options.height && (e += this.$tableFooter.outerHeight(!0))), this.options.height) {
                    var i = this.$toolbar.outerHeight(!0), n = this.$pagination.outerHeight(!0),
                        o = this.options.height - i - n, r = this.$tableBody.find("table").outerHeight(!0);
            ...
            key: "expandRow", value: function (t, e) {
                var i = this.data[t], n = this.$body.find(Mo.sprintf('> tr[data-index="%s"][data-has-detail-view]', t));
            ...
            key: "collapseRow", value: function (t) {
                var e = this.data[t], i = this.$body.find(Mo.sprintf('> tr[data-index="%s"][data-has-detail-view]', t));
    ...
    return qo.VERSION = Bo.VERSION, qo.DEFAULTS = Bo.DEFAULTS, qo.LOCALES = Bo.LOCALES, qo.COLUMN_DEFAULTS = Bo.COLUMN_DEFAULTS, qo.METHODS = Bo.METHODS, qo.EVENTS = Bo.EVENTS, t.BootstrapTable = qo, t.fn.bootstrapTable = function (e) {
        ...
        return this.each((function (i, o) {
            var a = t(o).data("bootstrap.table"), s = t.extend({}, qo.DEFAULTS, t(o).data(), "object" === Co(e) && e);
            if ("string" == typeof e) {
                var l;
